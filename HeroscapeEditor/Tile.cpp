...
// The map code table for exporting
// 
const std::map<int, std::string> CTile::m_mapCodes{
    {TYPE_GRASS * 1000 + 1, "GR1H"},
    {TYPE_GRASS * 1000 + 2, "GR2H"},
    {TYPE_GRASS * 1000 + 3, "GR3H"},
    {TYPE_GRASS * 1000 + 7, "GR7H"},
    {TYPE_GRASS * 1000 + 24, "GR24"},
    {TYPE_ROCK * 1000 + 1, "RK1H"},
    {TYPE_ROCK * 1000 + 2, "RK2H"},
    {TYPE_ROCK * 1000 + 3, "RK3H"},
    {TYPE_ROCK * 1000 + 7, "RK7H"},
    {TYPE_ROCK * 1000 + 24, "RK24"},
    {TYPE_SAND * 1000 + 1, "SA1H"},
    {TYPE_SAND * 1000 + 2, "SA2H"},
    {TYPE_SAND * 1000 + 3, "SA3H"},
    {TYPE_SAND * 1000 + 7, "SA7H"},
    {TYPE_WATER * 1000 + 1, "WA1H"},
    {TYPE_WATER * 1000 + 2, "WA1H"},
    {TYPE_RUIN * 1000 + 2, "RUSM"},
    {TYPE_RUIN * 1000 + 3, "RULG"},
    {TYPE_SWAMP * 1000 + 1, "SW1H"},
    {TYPE_SWAMP * 1000 + 2, "SW2H"},
    {TYPE_SWAMP * 1000 + 3, "SW3H"},
    {TYPE_SWAMP * 1000 + 7, "SW7H"},
    {TYPE_SWAMP * 1000 + 24, "SW24"},
    {TYPE_SWAMPWATER * 1000 + 1, "SWW1"},
    {TYPE_SWAMPWATER * 1000 + 6, "SWW6"},
    {TYPE_HIVE * 1000 + 6, "HIVE"},
    {TYPE_DUNGEON * 1000 + 1, "DG1H"},
    {TYPE_DUNGEON * 1000 + 2, "DG2H"},
    {TYPE_DUNGEON * 1000 + 3, "DG3H"},
    {TYPE_DUNGEON * 1000 + 7, "DG7H"},
    {TYPE_DUNGEON * 1000 + 24, "DG24"},
    {TYPE_SHADOW * 1000 + 1, "SD1H"},
    {TYPE_SHADOW * 1000 + 3, "SD3H"},
    {TYPE_OUTCROP * 1000 + 1, "OC1H"},
    {TYPE_OUTCROP * 1000 + 3, "OC3H"},
    {TYPE_ASPHALT * 1000 + 1, "AS1H"},
    {TYPE_ASPHALT * 1000 + 2, "AS2H"},
    {TYPE_ASPHALT * 1000 + 7, "AS7H"},
    {TYPE_CONCRETE * 1000 + 1, "CO1H"},
    {TYPE_CONCRETE * 1000 + 2, "CO2H"},
    {TYPE_CONCRETE * 1000 + 6, "CO6H"},
    {TYPE_CONCRETE * 1000 + 7, "CO7H"},
    {TYPE_RUIN * 1000 + 6, "WRYW"},
    {TYPE_RUIN * 1000 + 7, "WRNW"},
    {TYPE_ROAD * 1000 + 1, "RD1H"},
    {TYPE_ROAD * 1000 + 2, "RD2H"},
    {TYPE_ROAD * 1000 + 5, "RD5H"},
    {TYPE_TREE * 1000 + 11, "TR10"},
    {TYPE_TREE * 1000 + 12, "TR11"},
    {TYPE_TREE * 1000 + 13, "TR12"},
    {TYPE_TREE * 1000 + 4, "TR15"},
    {TYPE_WALL * 1000 + 4, "FRWL"},
    {TYPE_LAVAFIELD * 1000 + 1, "LF1H"},
    {TYPE_LAVAFIELD * 1000 + 2, "LF2H"},
    {TYPE_LAVAFIELD * 1000 + 7, "LF7H"},
    {TYPE_LAVA * 1000 + 1, "LV1H"},
    {TYPE_SNOW * 1000 + 1, "SN1H"},
    {TYPE_SNOW * 1000 + 2, "SN2H"},
    {TYPE_ICE * 1000 + 1, "IC1H"},
    {TYPE_ICE * 1000 + 3, "IC3H"},
    {TYPE_ICE * 1000 + 4, "IC4H"},
    {TYPE_ICE * 1000 + 6, "IC6H"},
    {TYPE_GLACIER * 1000 + 1, "GC1H"},
    {TYPE_GLACIER * 1000 + 3, "GC3H"},
    {TYPE_GLACIER * 1000 + 4, "GC4H"},
    {TYPE_GLACIER * 1000 + 6, "GC6H"},
    {TYPE_CASTLE * 1000 + 1, "RD1H"},
    {TYPE_CASTLE * 1000 + 7, "RD7H"},
    {TYPE_CASTLE * 1000 + 9, "RD9H"},
    {TYPE_CASTLE * 1000 + 101, "CBCN"},
    {TYPE_CASTLE * 1000 + 102, "CBST"},
    {TYPE_CASTLE * 1000 + 103, "CBED"},
    {TYPE_CASTLE * 1000 + 201, "CWCN"},
    {TYPE_CASTLE * 1000 + 202, "CWST"},
    {TYPE_CASTLE * 1000 + 203, "CWED"},
    {TYPE_CASTLE * 1000 + 301, "BT1H"},
    {TYPE_CASTLE * 1000 + 401, "CAYD"},
    {TYPE_CASTLE * 1000 + 402, "LD1H"},
    {TYPE_CASTLE * 1000 + 403, "BF1H"},
    {TYPE_CASTLE * 1000 + 404, "CAND"},
    {TYPE_TICALLA * 1000 + 1, "JT15"},
    {TYPE_TICALLA * 1000 + 2, "JB09"},
    {TYPE_TICALLA * 1000 + 14, "JT14"},
    {TYPE_TICALLA * 1000 + 15, "JT15"},
    {TYPE_TICALLA * 1000 + 16, "JT16"},
    {TYPE_STARTAREA * 1000 + 1, "SZ??"},
    {TYPE_GLYPH * 1000 + 1, "GL??"},
};
// The constructor
//
CTile::CTile()
